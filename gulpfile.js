...
const set_plugin_version = (pluginName) => {
  let version;
  const pkJSONPath = `${g3w.pluginsFolder}/${pluginName}/package.json`;
  try {
...
const set_app_version = async () => {
  ...
  console.log(`[G3W-CLIENT] -> VERSION: ${version}.${branch}:${commit}`)

  // client
  fs.writeFileSync('src/version.js', `/* Generated by gulpfile.js, do not edit manually */\n\nexport default '${version}.${branch}:${commit}';`);
