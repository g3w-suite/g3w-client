...
gulp.task('browserify:app', function() {
    //create and overwrite plugins version.js file to store plugin
    fs.writeFileSync('src/plugins/_version.js', `/* Generated by gulpfile.js, do not edit manually */\n\nexport default ${JSON.stringify(loaded_plugins)};`);
