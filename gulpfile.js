...
// Bacward compatibility with previous config.template.js (v3.x)
if (g3w.g3w_admin_paths) {
  g3w.admin_plugins_folder   = g3w.g3w_admin_paths.dev.g3w_admin_plugins_basepath;
  g3w.admin_static_folder    = g3w.g3w_admin_paths.dev.g3w_admin_client_dest_static;
  g3w.admin_templates_folder = g3w.g3w_admin_paths.dev.g3w_admin_client_dest_template;
}
g3w.port                     = g3w.port ?? g3w.localServerPort ?? 3000;
g3w.proxy.routes             = g3w.proxy.routes ?? g3w.proxy.urls; 
