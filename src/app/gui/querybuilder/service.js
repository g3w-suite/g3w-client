...
class QueryBuilderService {
  ...
  getValues = async function ({ layerId, field } = {}) {
    ...
    const valuesField = this._cacheValues[layerId][field];
    ...
    return new Promise((resolve, reject) => {
      GUI.dialog.confirm(t('sdk.querybuilder.delete'), (result) => {
        if (result) {
          ...
          if (querybuildersearches.length) saveitems[projectId] = querybuildersearches;
  ...
  save({
    id, name, layerId, filter, projectId,
  } = {}) {
