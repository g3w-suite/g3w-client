...
const {
  inherit, base, copyUrl, uniqueId, debounce, throttle, toRawType, createFilterFromString,
...
const { getScaleFromResolution, getResolutionFromScale } = require('g3w-ol/utils/utils');
