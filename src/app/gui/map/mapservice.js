...
import {Point, Polygon, MultiPolygon, Geometry} from "ol/geom";
import {transform, transformExtent, get} from "ol/proj";
import {getCenter, containsExtent, getWidth, getHeight, extend} from 'ol/extent';
...
//setup controls
  ...
  createMapControl(type, {id, add=true, toggled=false, visible, options={}}={}) {
    id = id || type;
