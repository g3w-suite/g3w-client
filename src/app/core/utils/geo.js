...
const geoutils = {
   ...
   */
  getQueryLayersPromisesByBBOX(layers, {
   ...
   * @returns {JQuery.Promise<any, any, any>}
   */
  getQueryLayersPromisesByGeometry(layers, {
  ...
  convertSingleMultiGeometry(geometry, toGeometryType) {
    if (toGeometryType) {
      ...
      if (!isFromGeometryMulti && isToGeometryMulti) return geoutils.singleGeometriesToMultiGeometry(geometry);
    }
    return geometry;
  },
