export default {
  ...
  'Selected layer:': 'Шар:',
  '__NONE__': 'НІЧОГО',
  '__NEW__': 'ТИМЧАСОВИЙ ШАР',
  '__ALL__': 'ВСЕ',
  'select a polygon': 'вибрати полігоном',
  'draw a polygon': 'оцифрувати полігон',
  'draw a rectangle': 'оцифрувати прямокутник',
  'draw a circle': 'оцифрувати коло',
  'Attributes download': 'Завантижити атрибути',
  'Features only': 'Тільки об’єкти',
  'Features+Query Polygon': 'Об’єкти та полігон',
  'No geometry on response': 'Відповідь не містить геометрії',
