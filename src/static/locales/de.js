export default {
  ...
  'Results': 'Ergebnisse',
  'Open attached document': 'Beigefügtes Dokument öffnen',
  ...
  'Attributes download': 'Attribute herunterladen',
  'Features only': 'Nur Features',
  'No geometry on response': 'Keine Geometrie in der Antwort',
  'Select a (visible) layer.': 'Wählen Sie eine (sichtbare) Ebene aus.',
  'Click on a geometry within map.': 'Klicken Sie auf ein Geometrie-Objekt in der Karte.',
  'Click on map to add a new vertex': 'Klicken Sie auf die Karte, um einen neuen Stützpunkt hinzuzufügen.',
  'Double click to finish and query layers': 'Doppelklick zum Beenden und Abfragen der Ebenen.',
  'Drag the mouse to draw a rectangle and query layers': 'Ziehen Sie die Maus, um ein Rechteck zu zeichnen und Ebenen abzufragen.',
  'Click on map to draw circle': 'Klicken Sie auf die Karte, um einen Kreis zu zeichnen.',
  'Drag the mouse to draw a polygon and query layers': 'Ziehen Sie die Maus, um ein Polygon zu zeichnen und Ebenen abzufragen.',
  ...
  'FEES': 'GEBÜHREN',
  'ACCESS CONSTRAINT': 'ZUGRIFFSBESCHRÄNKUNG',
  'CONTACTS': 'KONTAKTE',
