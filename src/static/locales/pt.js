export default {
  ...
  'Results': 'Resultados',
  'List of Relations': 'Lista de Relações',
  'Open attached document': 'Abrir documento anexo',
  ...
  'Selected layer:': 'Selecionar camadas:',
  '__NONE__': 'NENHUM',
  '__NEW__': 'CAMADA TEMPORÁRIA',
  '__ALL__': 'TODOS',
  'intersects': 'interseção',
  'within': 'dentro de',
  'select a polygon': 'selecione um polígono',
  'draw a polygon': 'desenhe um polígono',
  'draw a rectangle': 'desenhe um retangulo',
  'draw a circle': 'desenhe um círculo',
  'Attributes download': 'Descarregar atributos',
  'Features only': 'Apenas geometrias',
  'Features+Query Polygon': 'Consultar Camadas+Polígono',
  'No geometry on response': 'Resposta sem geometrias',
  'Select a (visible) layer.': 'Selecione uma camada (visível).',
  'Click on a geometry within map.': 'Clique em uma geometria no mapa.',
  'Click on map to add a new vertex': 'Clique no mapa para adicionar um novo vértice.',
  'Double click to finish and query layers': 'Clique duas vezes para terminar e consultar as camadas.',
  'Drag the mouse to draw a rectangle and query layers': 'Arraste o rato para desenhar um retângulo e consultar as camadas.',
  'Click on map to draw circle': 'Clique no mapa para desenhar um círculo.',
  'Drag the mouse to draw a polygon and query layers': 'Arraste o rato para desenhar um polígono e consultar as camadas.',
  ...
  'FEES': 'TAXAS',
  'ACCESS CONSTRAINT': 'RESTRIÇÃO DE ACESSO',
  'CONTACTS': 'CONTATOS',
