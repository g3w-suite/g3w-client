export default {
  ...
  'Attributes download': 'Téléchargement des attributs',
  'Features only': 'Entités seulement',
  'Features+Query Polygon': 'Entités+Requête Polygon',
  'No geometry on response': 'La réponse ne contient pas de géométrie',
  'Select a (visible) layer.': 'Sélectionnez une couche (visible).',
  'Click on a geometry within map.': 'Cliquez sur une géométrie dans la carte.',
  'Click on map to add a new vertex': 'Cliquez sulla carte pour ajouter un nouveau sommet.',
  'Double click to finish and query layers': 'Double-cliquez pour terminer et interroger les couches.',
  'Drag the mouse to draw a rectangle and query layers': 'Faites glisser la souris pour dessiner un rectangle et interroger les couches.',
  'Click on map to draw circle': 'Cliquez sur la carte pour dessiner un cercle.',
  'Drag the mouse to draw a polygon and query layers': 'Faites glisser la souris pour dessiner un polygone et interroger les couches.',
