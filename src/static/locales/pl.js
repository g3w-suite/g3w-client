export default {
  ...
  'Results': 'Wyniki',
  'List of Relations': 'Lista relacji',
  'Open attached document': 'Otwarty załączony dokument',
  ...
  'Attributes download': 'Pobieranie atrybutów',
  'Features only': 'Tylko funkcje',
  'Features+Query Polygon': 'Funkcje+Polygon zapytania',
  'No geometry on response': 'Brak geometrii w odpowiedzi',
  'Select a (visible) layer.': 'Wybierz (widoczną) warstwę.',
  'Click on a geometry within map.': 'Kliknij obiekt geometryczny na mapie.',
  'Click on map to add a new vertex': 'Kliknij na mapie, aby dodać nowy wierzchołek.',
  'Double click to finish and query layers': 'Kliknij dwukrotnie, aby zakończyć i odpytać warstwy.',
  'Drag the mouse to draw a rectangle and query layers': 'Przeciągnij myszą, aby narysować prostokąt i odpytać warstwy.',
  'Click on map to draw circle': 'Kliknij na mapie, aby narysować koło.',
  'Drag the mouse to draw a polygon and query layers': 'Przeciągnij myszą, aby narysować poligon i odpytać warstwy.',
  ...
  'FEES': 'OPŁATY',
  'ACCESS CONSTRAINT': 'Ograniczenie dostępu',
  'CONTACTS': 'ŁĄCZNOŚĆ',
  'Email': 'E-mail',
