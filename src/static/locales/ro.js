export default {
  ...
  'CONTACTS': 'CONTACTE',
  'metadata.contactelectronicmailaddress': 'Email',
  'metadata.personprimary': 'Referințe',
  'metadata.contactvoicetelephone': 'Telefon',
  'metadata.contactorganization': 'Organizație',
  'metadata.ContactOrganization': 'Organizație',
  'metadata.contactposition': 'Poziție',
  'metadata.ContactPosition': 'Poziție',
  'metadata.contactperson': 'Persoana',
  'metadata.ContactPerson': 'Persoana',
  'SPATIAL': 'SPAȚIAL',
  'LAYERS': 'STRATURI',
  'GEOMETRY': 'GEOMETRIE',
