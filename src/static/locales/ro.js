export default {
  ...
  'Open attached document': 'Deschide document atașat',
  ...
  'Attributes download': 'Descărcare atribute',
  'Features only': 'Doar entități',
  'Features+Query Polygon': 'Entități+Poligon Interogare',
  'No geometry on response': 'Nu avem geometrii în răspuns',
  'Select a (visible) layer.': 'Selectați un strat (vizibil).',
  'Click on a geometry within map.': 'Faceți clic pe o geometrie din hartă.',
  'Click on map to add a new vertex': 'Faceți clic pe hartă pentru a adăuga un nou vârf.',
  'Double click to finish and query layers': 'Faceți dublu clic pentru a termina și a interoga straturile.',
  'Drag the mouse to draw a rectangle and query layers': 'Trageți mouse-ul pentru a desena un dreptunghi și a interoga straturile.',
  'Click on map to draw circle': 'Faceți clic pe hartă pentru a desena un cerc.',
  'Drag the mouse to draw a polygon and query layers': 'Trageți mouse-ul pentru a desena un poligon și a interoga straturile.',
  ...
  'FEES': 'TAXE',
  'ACCESS CONSTRAINT': 'CONSTRÂNGERI DE ACCES',
  'CONTACTS': 'CONTACTE',
