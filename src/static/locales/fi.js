export default {
  ...
  'metadata.contactelectronicmailaddress': 'Sähköposti',
  'metadata.personprimary': 'Viitteet',
  'metadata.contactvoicetelephone': 'Puhelin',
  'metadata.contactorganization': 'Organisaatio',
  'metadata.ContactOrganization': 'Organisaatio',
  'metadata.contactposition': 'Asema',
  'metadata.ContactPosition': 'Asema',
  'metadata.contactperson': 'Yhteyshenkilö',
  'metadata.ContactPerson': 'Yhteyshenkilö',
  'LAYERS': 'TASOT',
  'GEOMETRY': 'GEOMETRIA',
  'SOURCE': 'LÄHDE',
