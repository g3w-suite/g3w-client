export default {
  ...
  'Open attached document': 'Avaa liitetiedosto',
  ...
  'Select a (visible) layer.': 'Valitse (näkyvä) taso.',
  'Click on a geometry within map.': 'Napsauta kartalla olevaa geometriaa.',
  'Click on map to add a new vertex': 'Lisää uusi piste napsauttamalla karttaa.',
  'Double click to finish and query layers': 'Lopeta ja tee haku tasoista kaksoisnapsauttamalla.',
  'Drag the mouse to draw a rectangle and query layers': 'Piirrä suorakulmio ja tee haku tasoista vetämällä hiirellä.',
  'Click on map to draw circle': 'Piirrä ympyrä napsauttamalla karttaa.',
  'Drag the mouse to draw a polygon and query layers': 'Piirrä monikulmio ja tee haku tasoista vetämällä hiirellä.',
  ...
  'KEYWORDS': 'AVAINSANAT',
  'FEES': 'MAKSUT',
  'ACCESS CONSTRAINT': 'PÄÄSYRAJOITUKSET',
