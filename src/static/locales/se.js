export default {
  ...
  'Results': 'Resultat',
  'Open attached document': 'Öppna filbilaga',
  ...
  'No geometry on response': 'No geometry on response',
  'Select a (visible) layer.': 'Välj ett (synligt) lager.',
  'Click on a geometry within map.': 'Klicka på en geometri i kartan.',
  'Click on map to add a new vertex': 'Klicka på kartan för att lägga till en ny brytpunkt.',
  'Double click to finish and query layers': 'Dubbelklicka för att slutföra och hämta data från lager.',
  'Drag the mouse to draw a rectangle and query layers': 'Dra musen för att rita en rektangel och hämta data från lager.',
  'Click on map to draw circle': 'Klicka på kartan för att rita en cirkel.',
  'Drag the mouse to draw a polygon and query layers': 'Dra musen för att rita en polygon och hämta data från lager.',
  ...
  'KEYWORDS': 'NYCKELORD',
  'FEES': 'AVGIFTER',
  'ACCESS CONSTRAINT': 'ÅTKOMSTBEGRÄNSNINGAR',
