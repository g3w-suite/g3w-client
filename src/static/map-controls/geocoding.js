...
document.head.insertAdjacentHTML(
  ...
  /* css */`
<style>
  .ol-geocoder                                                         { width: 300px; margin-top: 3px; margin-left: calc(var(--ol-map-pad-left) + 5px) !important; --skin-color: #374146; }
  body:not(.sidebar-collapse) .ol-geocoder,
  body.is-iframe:not(.sidebar-mini).sidebar-collapse .ol-geocoder      { margin-left: calc(var(--ol-map-pad-left) + 40px) !important; }
