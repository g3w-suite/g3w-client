...
<style>
  ...
  #catalog .tree-item > .toggle-context-menu                                     { opacity: 0; position: absolute; inset: 0 4px auto auto; padding: 4px 8px;  border-radius: 5px; background-color: hsl(from var(--bgcolor) h s calc(l - 2)); }
