    ...
    >
      ...
      <span v-t="'sdk.catalog.choose_map_theme'"></span>
          ...
          <span
            ...
            style="margin-left: auto; font-size: 1.2em; padding: 5px;"
          >
      </span>
        </section>
        ...
        >
          <div class="form-group">
            <label for="save-map-theme-input" class="skin-color">Nome</label>
            <input id="save-map-theme-input" style="margin-bottom: 0" v-model="themeName" class="form-control">
          </div>
          <button
            @click.stop="save"
            v-disabled="!canSave"
            style="height: 50px; font-weight: bold"
            class="btn skin-background-color" v-t="'save'">
          </button>
        </section>
      </a>
...
<script>
  ...
  export default {
    ...
    data() {
      const collapsed = 'collapsed' === ProjectsRegistry.getCurrentProject().state.toc_themes_init_status ;
