...
document.head.insertAdjacentHTML('beforeend', /* html */`<style id ="x-select-css">
  ...
  x-option                                       { padding: 8px 12px; display: flex; align-items: center; cursor: pointer; color: #333; border-bottom: 1px solid #eee; outline: none !important; scroll-margin-top: 85px; }
