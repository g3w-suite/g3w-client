...
document.head.insertAdjacentHTML('beforeend', /* html */`<style id ="x-select-css">
  ...
  .x-select-trigger           { border: 1px solid #ccc; padding: 6px 6px 6px 12px; display: flex; align-items: center; min-height: 30px; cursor: pointer; box-sizing: border-box; user-select: none; }
