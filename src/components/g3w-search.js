...
export function SearchComponent(opts = {}) {
  ...
  const service = opts.service || new (class extends G3WObject {
    ...
    constructor() {
      ...
      this.init = searches => { this.state.searches = searches || currentProjectState.search; };
      this.state = {
        searches: [],
        searchtools: [],
 ...
 */
export function SearchPanel(opts = {}) {
 ...
 */
export function SearchService(config = {}) {
