  ...
  <ul class="treeview-menu g3w-tools menu-items">
    ...
    <li style="display: flex; flex-direction: column; justify-content: space-between; background: transparent !important; margin-bottom: 10px;">
      ...
      <div class="wms_url_input_content">
        ...
        <input id="add_custom_url_wms_input" v-model="url" class="form-control" style="width: 100%; color:#000000;">
      </div>
      <div>
        <button v-disabled="!inputswmsurlvalid" style="width: 100%;" @click.prevent.stop="addwmsurl" class="btn btn-block skin-background-color">
      ...
      <div style="max-height: 200px; overflow-y: auto;">
        ...
        <div v-for="({id, url}) in state.localwmsurls" :key="id" style="border-bottom: 1px solid #cccccc; padding-bottom: 3px;">
          <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 3px">
            ...
            <span style="color: red; padding: 3px; margin: 2px;" @click.stop="deleteWmsUrl(id)" v-t-tooltip:top.create="'sidebar.wms.delete_wms_url'">
