    ...
    <li style="display: flex; flex-direction: column; justify-content: space-between; background: transparent !important; margin-bottom: 10px;">
      ...
      <div class="wms_url_input_content">
        ...
        <input
          ...
          v-model="id"
          class="form-control" style="width: 100%; color:#000000;">
      </div>
    ...
    <li class="skin-border-color" style="background: transparent !important; border-top: 2px solid">
      <div style="max-height: 200px; overflow-y: auto;">
        ...
        <div
          ...
          :key="wmsurl" style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #cccccc; padding-bottom: 3px;"
        >
          <span
