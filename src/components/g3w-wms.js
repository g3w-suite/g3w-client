...
/**
 * ORIGINAL SOURCE: src/app/gui/wms/vue/wms.js@v3.9.3
 */
...
class Service {
  ...
  showWmsLayersPanel(config={}) {
    ...
    this.panel.unmount = () => Panel.prototype.unmount.call(this.panel).then(() => this.clear());
    this.panel.show();
    return this.panel;
  }
